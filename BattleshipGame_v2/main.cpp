 ...
 * File:   main.cpp
 * Author: Seth Cross
 * Created on April 18, 2023, 11:50 AM
 * Purpose:Battleship game v2 
 */
...
int main(int argc, char** argv) {
    ...
    do {
        ...
        //In this version, battleships will be taken out of valid input range to prevent
        //the same battleship getting hit twice
        if (choice == bship1){
            bship1+=1000; //Setting Battleship out of range, so that it cant be sunk twice
            ...
            bship2+=1000; //Setting Battleship out of range, so that it cant be sunk twice
            hitCnt++;//+1 to hit counter
            cout << endl << "HIT! Enemy Battleship Destroyed!" << endl;
            cout << "You have sunk " << hitCnt << " Battleships!" << endl <<endl;
        }
            ...
            bship3+=1000; //Setting Battleship out of range, so that it cant be sunk twice
            hitCnt++;//+1 to hit counter
            cout << endl << "HIT! Enemy Battleship Destroyed!" << endl;
            cout << "You have sunk " << hitCnt << " Battleships!" << endl <<endl;
        }
            ...
            bship4+=1000; //Setting Battleship out of range, so that it cant be sunk twice
            hitCnt++;//+1 to hit counter
            cout << endl << "HIT! Enemy Battleship Destroyed!" << endl;
            cout << "You have sunk " << hitCnt << " Battleships!" << endl <<endl;
        }
            ...
            bship5+=1000; //Setting Battleship out of range, so that it cant be sunk twice
            hitCnt++;//+1 to hit counter
            cout << endl << "HIT! Enemy Battleship Destroyed!" << endl;
            cout << "You have sunk " << hitCnt << " Battleships!" << endl <<endl;
        }
