 ...
 * File:   main.cpp
 * Author: Seth Cross
 * Created on April 2, 2023, 9:35 PM
 * Purpose:Battleship positioning program v4
 */
...
int main(int argc, char** argv) {
    ...
    //In v3, cleaned up the do-while loop, works the same as previous version
    do {
        bship1=rand()%21;//[0,20]
        bship2=rand()%21;//[0,20]
        bship3=rand()%21;//[0,20]
        ...
        bship5=rand()%21;//[0,20]
            ...
            ||bship4 == bship5);
    //In v4, cleaned up do-while even more. 
